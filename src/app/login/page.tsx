    ...
    <div className="min-h-screen flex items-center justify-center px-6">
      ...
      <div className="w-full max-w-md relative">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Sign in to continue your career journey</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="glass p-8 space-y-5">
          ...
          <p className="text-center text-sm text-slate-500">
            New here? <Link href="/register" className="text-indigo-400 hover:text-indigo-300">Create account</Link>
          </p>
        </form>
      </div>
    </div>
