...
import { Compass, ArrowRight, ArrowLeft, Loader2, Check } from "lucide-react";
...
const SKILLS = [
  ...
  "Cooking", "Teaching", "Carpentry", "Mechanical Repair", "Electrical",
  "Research", "Statistics", "Financial Modeling", "Budgeting",
  "Customer Service", "Teamwork", "Time Management", "Organization",
];
        ...
        <div className="glass p-8 mb-6">
                    ...
                    {["low", "medium", "high"].map(level => (
                      <button key={level} onClick={() => setPersonality(trait.key, level)}
                        className={`flex-1 py-1.5 rounded-lg text-xs font-medium transition-all ${
                          data.personality[trait.key] === level
                            ? "bg-indigo-500 text-white"
          ...
          {step === 4 && (
            <div className="space-y-6">
              ...
              <div>
                <h3 className="font-medium mb-3">Highest Education</h3>
        ...
        <div className="flex items-center justify-between">
          ...
          {step < STEPS.length - 1 ? (
            ...
            <button onClick={handleSubmit} disabled={loading}
              ...
              {loading ? "Analyzing..." : "Find My Paths"}
            </button>
          )}
        </div>
      </div>
