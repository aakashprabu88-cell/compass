...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json(result, { headers: getRateLimitHeaders(rateKey, 30, 60000) });
  } catch (err: any) {
